...
<body>
    ...
    <section class="pet-search">
        <div class="container">
            ...
            <form action="../controller/adoptController.php" method="post" class="adopt">
                <fieldset>
                    ...
                    <input type="tel" name="contact" placeholder="E.g. +88016XXXXXXX" class="input-responsive" required>
